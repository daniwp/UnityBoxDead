...
public class vCharacterEditor : Editor
{
    ...
    private static void CustomDrawGizmos(Transform aTarget, GizmoType aGizmoType)
    {
        ...
        if (Application.isPlaying)
        {
            ...
            // debug stepOffset
            Ray ray5 = new Ray((motor.transform.position + new Vector3(0, motor.stepOffsetEnd, 0) + motor.transform.forward * ((motor.GetComponent<CapsuleCollider>()).radius + 0.05f)), Vector3.down);
